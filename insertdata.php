...
//บันทึกข้อมูล
$sql = "INSERT INTO employee(emp_title,emp_name,emp_surname,emp_birthday,emp_adr,
emp_skill,emp_tel,emp_user,emp_pass,emp_level) 
VALUE('$emp_title','$emp_name','$emp_surname','$emp_birthday','$emp_adr',
'$emp_skill','$emp_tel','$emp_user','$emp_pass','$emp_level')";
