...
?>
  ...
  <body>
    <div class="container">
      ...
      <p><i class='bx bx-user-voice'></i> สวัสดี <?php echo $row["emp_title"];
                                                    echo $row["emp_name"];
                                                    echo "&nbsp";
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            ...
            <td><a href="deletedata.php?emp_id=<?php echo $row['emp_id']; ?>" class="btn btn-danger" onclick="return confirm('คุณต้องการลบข้อมูลพนักงานคนนี้หรือไม่?');">ลบ</a></td>
          </tr>
        </tbody>
      </table>
    </div>
